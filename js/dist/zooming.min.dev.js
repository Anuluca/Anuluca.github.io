...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Zooming = e();
}(void 0, function () {
  "use strict";
  ...
  function o(t, e, i) {
    ...
    !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3] ? t.addEventListener(e, i, n) : t.removeEventListener(e, i, n);
  }
  ...
  var g = {
    init: function init(t) {
      this.el = document.createElement("div"), this.instance = t, this.parent = document.body, l(this.el, {
        position: "fixed",
        top: 0,
        left: 0,
        right: 0,
        bottom: 0,
        opacity: 0
      }), this.updateStyle(t.options), o(this.el, "click", t.handler.clickOverlay.bind(t));
    },
    updateStyle: function updateStyle(t) {
      l(this.el, {
        zIndex: t.zIndex,
    ...
    fadeOut: function fadeOut() {
      ...
      v = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
    return _typeof(t);
  } : function (t) {
    ...
    init: function init(t, e) {
      this.el = t, this.instance = e, this.srcThumbnail = this.el.getAttribute("src"), this.srcset = this.el.getAttribute("srcset"), this.srcOriginal = a(this.el), this.rect = this.el.getBoundingClientRect(), this.translate = null, this.scale = null, this.styleOpen = null, this.styleClose = null;
    },
    zoomIn: function zoomIn() {
      ...
      }, this.el.offsetWidth, this.styleClose = l(this.el, this.styleOpen, !0);
    },
    zoomOut: function zoomOut() {
      this.el.offsetWidth, l(this.el, {
        transform: "none"
      });
    },
    grab: function grab(t, e, i) {
      var n = k(),
          o = n.x - t,
          r = n.y - e;
      l(this.el, {
    ...
    calculateScale: function calculateScale() {
      ...
      if (s && "object" === (void 0 === s ? "undefined" : v(s))) return {
  ...
  return function () {
    function i(t) {
      b(this, i), this.target = Object.create(O), this.overlay = Object.create(g), this.handler = Object.create(p), this.body = document.body, this.shown = !1, this.lock = !1, this.released = !0, this.lastScrollPosition = null, this.pressTimer = null, this.options = x({}, f, t), this.overlay.init(this), this.handler.init(this);
    }

    return w(i, [{
      key: "listen",
      value: function value(t) {
        if ("string" == typeof t) for (var i = document.querySelectorAll(t), n = i.length; n--;) {
          this.listen(i[n]);
      ...
      value: function value(t) {
        ...
        if (!this.shown && !this.lock) {
          ...
          if ("IMG" === n.tagName) {
            ...
            return o(n, u, function t() {
              o(n, u, t, !1), e.lock = !1, e.target.upgradeSource(), e.options.enableGrab && S(document, e.handler, !0), i(n);
            }), this;
          }
        }
      }
      ...
      value: function value() {
        ...
        if (this.shown && !this.lock) {
          ...
          return o(n, u, function t() {
            o(n, u, t, !1), e.shown = !1, e.lock = !1, e.target.downgradeSource(), e.options.enableGrab && S(document, e.handler, !1), e.target.restoreCloseStyle(), e.overlay.remove(), i(n);
          }), this;
        }
      }
    }, {
