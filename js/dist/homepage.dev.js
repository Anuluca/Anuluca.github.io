...
$(".note_guide").mouseenter(function () {
  ...
  $(".guidePic").css({
    backgroundImage: "url('https://cdn.jsdelivr.net/gh/Anuluca/anulucImage@1.2/other/YfLHgA.jpg')"
  });
});
$(".nintendo_guide").mouseenter(function () {
  ...
  $(".guidePic").css({
    backgroundImage: "url('https://cdn.jsdelivr.net/gh/Anuluca/anulucImage@1.2/other/IMG_6139.JPG')"
  });
});
$(".jay_guide").mouseenter(function () {
  ...
  $(".guidePic").css({
    backgroundImage: "url('https://cdn.jsdelivr.net/gh/Anuluca/anulucImage@1.2/other/2145F6682FBCE287815AF6DC59D0C5A5.png')"
  });
});
$(".home_guide").mouseenter(function () {
  ...
  $(".guidePic").css({
    backgroundImage: "url('https://cdn.jsdelivr.net/gh/Anuluca/anulucImage@1.2/other/waoh6O.jpg')"
  });
