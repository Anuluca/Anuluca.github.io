...
$(".note_guide").mouseenter(function(){
    ...
    $(".guidePic").css({ backgroundImage: "url('https://cdn.jsdelivr.net/gh/Anuluca/anulucImage@1.2/other/YfLHgA.jpg')" });
})
$(".nintendo_guide").mouseenter(function(){
    $('.zhegaib').stop().animate({ width: "0" }, 150);
    $('.zhegaia,.zhegaic,.zhegaid').stop().animate({ width: "100%" }, 150);
    $(".guidePic").css({ backgroundImage: "url('https://cdn.jsdelivr.net/gh/Anuluca/anulucImage@1.2/other/IMG_6139.JPG')" });
})
$(".jay_guide").mouseenter(function(){
    $('.zhegaic').stop().animate({ width: "0" }, 150);
    $('.zhegaia,.zhegaib,.zhegaid').stop().animate({ width: "100%" }, 150);
    $(".guidePic").css({ backgroundImage: "url('https://cdn.jsdelivr.net/gh/Anuluca/anulucImage@1.2/other/2145F6682FBCE287815AF6DC59D0C5A5.png')" });
})
$(".home_guide").mouseenter(function(){
    $('.zhegaid').stop().animate({ width: "0" }, 150);
    $('.zhegaia,.zhegaib,.zhegaic').stop().animate({ width: "100%" }, 150);
    $(".guidePic").css({ backgroundImage: "url('https://cdn.jsdelivr.net/gh/Anuluca/anulucImage@1.2/other/waoh6O.jpg')" });
})
...
$(".shits>div").mouseenter(function () {
    $(this).find(".shit_title_img").animate({ width: "310px", height: "190px", marginTop: "10px", marginLeft: "8px" }, 150)
    $(this).find("span:first-of-type").animate({ bottom: "20px", fontSize: "22px" }, 80)
    $(this).find("span:last-of-type").animate({ height: "0px" }, 200)
}).stop().mouseleave(function () {
    $(this).find(".shit_title_img").animate({ width: "300px", height: "180px", marginTop: "14px", marginLeft: "14px" }, 150)
    $(this).find("span:first-of-type").animate({ bottom: "30px", fontSize: "18px" }, 80)
    $(this).find("span:last-of-type").animate({ height: "12px" }, 200)
}).stop()

$(".ps-container img").stop().click(function(e){
    e.stopPropagation()
}).stop()
