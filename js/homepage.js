...
$(".note_guide").mouseenter(function () {
  ...
  $(".guidePic").css({
    backgroundImage:
      "url('http://pic.anuluca.com/other/YfLHgA.jpg')",
  });
});
$(".nintendo_guide").mouseenter(function () {
  ...
  $(".guidePic").css({
    backgroundImage:
      "url('http://pic.anuluca.com/other/IMG_6139.jpg')",
  });
});
$(".jay_guide").mouseenter(function () {
  ...
  $(".guidePic").css({
    backgroundImage:
      "url('http://pic.anuluca.com/other/2145F6682FBCE287815AF6DC59D0C5A5.png')",
  });
});
$(".home_guide").mouseenter(function () {
  ...
  $(".guidePic").css({
    backgroundImage:
      "url('http://pic.anuluca.com/other/waoh6O.jpg')",
  });
});
